...
class TestInlineMarkdown(unittest.TestCase):
    ...
    def test_extract_markdown_images_nuktiple(self):
        ...
        self.assertListEqual([("rick roll", "https://i.imgur.com/aKaOqIh.gif"), ("obi wan", "https://i.imgur.com/fJRm4Vk.jpeg")], text)
    ...
    def test_split_images_one(self):
        node = TextNode(
            "This is text with an ![image](https://i.imgur.com/zjjcJKZ.png) and another", TextType.TEXT,
        )
        new_nodes = split_nodes_image([node])
        self.assertListEqual(
            [
    ...
    def test_split_images_link_at_start(self):
        node = TextNode(
            "![image](https://i.imgur.com/zjjcJKZ.png) and another", TextType.TEXT,
        )
        new_nodes = split_nodes_image([node])
        self.assertListEqual(
            [
    ...
    def test_split_links_one(self):
        node = TextNode(
            "This is text with an [link](https://i.imgur.com/zjjcJKZ.png) and another", TextType.TEXT,
        )
        new_nodes = split_nodes_link([node])
        self.assertListEqual(
            [
    ...
    def test_split_links_link_at_start(self):
        node = TextNode(
            "[link](https://i.imgur.com/zjjcJKZ.png) and another", TextType.TEXT,
        )
        new_nodes = split_nodes_link([node])
        self.assertListEqual(
            [
    ...
    def test_split_links_no_space(self):
        node = TextNode(
