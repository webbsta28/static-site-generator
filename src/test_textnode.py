...
class TestTextNode(unittest.TestCase):
    def test_eq(self):
        ...
        node = TextNode("bamm", TextType.BOLD)
        node2 = TextNode("This is a text node", TextType.BOLD)
        self.assertNotEqual(node, node2)
        node = TextNode("This is a text node", TextType.TEXT, "https://example.com)")
        node2 = TextNode("This is a text node", TextType.BOLD, "https://example123.com")
        self.assertNotEqual(node, node2)
    ...
    def test_image(self):
        ...
        self.assertEqual(html_node.props, {'src': 'https://example.com', 'alt': "This is a text node"})
